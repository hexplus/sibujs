...
// islands/progressive-enhancement primitives. Everything else (router, SSR,
// data, browser wrappers, widgets, …) lives in the `sibujs` package, which
// depends on and re-exports this core.
// ---------------------------------------------------------------------------
